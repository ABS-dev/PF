...
okay_vars <- c("A", "B", "C", "L", "N", "Q", "R", "V", "Y", "L1", "L2",
               ...
               "Tau", "d.i", "m.i", "n.i", "p.i", "u.p", "v.i", "y.i", "z.s",
               "RRmh", "RRor", "RRsc", "ci.d", "g.ph", "logR", "r.ij", "varR",
               "wTau", "z.ph", "IDRsc", "RRlsi", "RRstr", "Terms", "V.eta",
               "ci.dl", "gradR", "p.set", "phiWt", "q.set", "r.hat", "r.max",
               "r.min", "rsbWt", "tauWt", "var.b", "y.dot", "z.ah2", "z.al2",
               "z.new", "z.old", "z.phi", "IDRlsi", "Phi.ML", "Table6",
               ...
               "rho.mle", "tau.hat", "tau.new", "varlogR", "zis.phi",
               "zsc.phi", "zsk.phi", "RRmpWald", "beta.hat", "bird.fit",
               "ci.asymp", "fit.only", "gradlogR", "hom.test", "iter.max",
               "old.high", "rr.ci.hi", "rr.ci.lo", "tauOptim", "trace.it",
               "birdm.fit", "this.call", "use.alpha", "var.log.r", "full.track",
               "grad.log.r", "show.warns", "var.log.rr", "drop.levels",
