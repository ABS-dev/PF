...
test_that("examples work", {
  ...
  thisestimate <- matrix(c(rep(0.6111111, 5), 
    -0.04824591, -0.06395343, 0.02505437, 0.03282894, 0.03796954,
    0.855726059905179, 0.835168605625983, 0.856770623929744, 0.855455017510877, 
    0.876306176546387), nrow = 5, ncol = 3, byrow = FALSE)
  ...
  expect_equal(ex1$y, c(4, 24, 12, 28))
