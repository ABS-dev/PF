...
test_that("check_3input_cases_freq", {
  ...
  expect_null(.check_3input_cases_freq(y = y1, data = data1, formula = formula1))
  expect_error(.check_3input_cases_freq(y = y2, data = data2, formula = formula2))
  expect_error(.check_3input_cases_freq(y = y3, data = data3, formula = formula3))
  expect_error(.check_3input_cases_freq(y = y4, data = data4, formula = formula4))
