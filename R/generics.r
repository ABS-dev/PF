...
print.rror <- function(x, ...) {
  ...
  options(digits = x$rnd)
  if (x$norm) {
    conf <- paste(100 * (1 - x$alpha),
                  "% gaussian intervals\n", sep = "")
  } else {
    conf <- paste(100 * (1 - x$alpha),
                  "% t intervals on ", x$degf, " df\n", sep = "")
  }
  cat("\n")
  cat(conf)
  cat("\n")
...
setMethod("show", "rror", function(object) {
  print(object)
})
...
setMethod("show", "rrsi", function(object) {
  print(object)
})
...
setMethod("show", "rrmp", function(object) {
  print(object)
})
...
setMethod("show", "rrsc", function(object) {
  print(object)
})
...
setMethod("show", "rrstr", function(object) {
  print(object)
})
